 ...
 * being fast (not a password KDF like bcrypt): a 6-digit code's entropy is
 * what actually needs protecting, and that's the job of the attempt cap +
 * short expiry enforced by the route, not the hash's slowness.
 */
