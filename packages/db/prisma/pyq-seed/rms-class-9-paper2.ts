...
import mathematics from "./audit/class9-paper2/rms9-math.json";
import mentalAbility from "./audit/class9-paper2/rms9-mental-ability.json";
import science from "./audit/class9-paper2/rms9-science.json";
import gk from "./audit/class9-paper2/rms9-gk.json";

// RMS Class 9, Paper 2 — the existing pool seeded by aissee-rms-class-9.ts
...
// until an admin publishes it. Independently authored from AISSEE's Class
// 9 Paper 2, not shared content. Drafted and verified in
