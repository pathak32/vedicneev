...
import arithmetic from "./audit/class6-paper1/aissee6-arithmetic.json";
import mentalAbility from "./audit/class6-paper1/aissee6-mental-ability.json";
import language from "./audit/class6-paper1/aissee6-language.json";
import gk from "./audit/class6-paper1/aissee6-gk.json";

// AISSEE Class 6, Paper 1 — the first of 20 planned discrete mock papers
...
// jnvstMockService.ts excludes DRAFT rows entirely. Drafted and verified
// in prisma/pyq-seed/audit/class6-paper1/.
