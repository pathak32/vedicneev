    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-amber-50/50 via-white to-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          {/* Main Headline (Optimized with relaxed line-height to prevent Indic text clipping) */}
          ...
          <p className="text-base sm:text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Comprehensive preparation for <strong className="text-gray-900">JNVST, AISSEE, and RMS</strong> (Classes 6 & 9) featuring real-percentile analytics, curated static master papers, and regional language support[cite: 1].
          </p>
